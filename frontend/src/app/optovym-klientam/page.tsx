      ...
      <section aria-label="Нестандартные заказы">
        <div className="wrap">
          ...
          <div className="grid-3">
            ...
            <div className="cell">
              <h3>Раскрой тонких матрасов в любой размер</h3>
              <p className="mt-8">Листовой латекс толщиной 20–50 мм режем под нестандартные кровати, яхты и детскую мебель. Рулоны до 8 метров.</p>
            </div>
            <div className="cell">
