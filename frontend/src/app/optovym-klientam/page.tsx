      ...
      <section aria-label="Материалы для партнёров">
        <div className="wrap">
          <div className="section-head">
            ...
            <p>
              Фото, сертификат и товарный фид доступны партнёрам после отправки
              заявки на этой странице — ссылки откроются автоматически.
              Презентации добавим по мере подготовки.
            </p>
          </div>
          <B2BMaterials />
        </div>
