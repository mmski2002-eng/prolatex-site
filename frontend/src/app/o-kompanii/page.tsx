...
export const metadata: Metadata = {
  ...
  description:
    "Про-Латекс — специалист по натуральному латексу, компания основана в 2009 году. Матрасы, подушки и тонкие матрасы из 100% бельгийского латекса Novaya.",
        ...
        <div className="wrap">
          <div className="article-body">
            <p>
              ...
              конкурентов: 9 моделей матрасов на независимых пружинах и
              монолитных латексных блоках, именная линейка латексных подушек и листовой
              латекс для тонких матрасов.
            </p>
            <p>
              Склады компании находятся в Москве и Санкт-Петербурге.
