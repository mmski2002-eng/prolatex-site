  ...
  return (
    <>
      ...
      <section className="page-hero" style={{ paddingTop: 8 }}>
        <div className="wrap">
          <h1 className="page-h1">Латексные матрасы — каталог из 11 моделей</h1>
          <p className="lead">
            Все матрасы Про-Латекс сделаны из 100% натурального бельгийского
            латекса Novaya. Три конструкции — пружинные на
            независимом пружинном блоке с 7 зонами, беспружинные монолитные и модели с
            интегрированным топпером. Жёсткость от мягкой до средней, высота
            от 12 до 29 см, размеры от 80×190 до 200×200 см.
          </p>
        </div>
      </section>
